        ...
        <div>
            ...
            <div className="relative">
                <input
                    ...
                    className="bg-transparent block w-full rounded-md border-0 py-1.5 pl-10 pr-1 text-gray-100 ring-2 ring-inset ring-gray-500 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-gray-600 sm:text-sm sm:leading-6"
